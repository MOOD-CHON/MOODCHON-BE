...
import com.example.moodchon.domain.save.service.SaveFolderPlaceQueryService;
...
public class SaveFolderController {
    ...
    private final SaveFolderPlaceQueryService saveFolderPlaceQueryService;
    ...
    @GetMapping("/{folderId}")
    public ApiResponse<SaveFolderDetailResponse> getDetail(
